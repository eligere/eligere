...
void MainWindow::section1_calculations()
{
    ...
    for (unsigned j=0; j<n; j++)
    {
        ...
        //ui->fuzzyResultsOnscreen->append("Score criterion [i]: "+QString::number(wS1Appoggio));

        std::cout<<"Score criterion [i]: "<<wS1Appoggio;
        std::cout << '\n';
    ...
    std::cout<<"Score criterion size: "<<wS1.size();
    std::cout << '\n';
...
*/
    ...
    std::cout << " ------------------------------------- ";
    std::cout << '\n';
    std::cout<<"dTotal size: "<<dTotal.size();
    std::cout << '\n';
    std::cout<<"dTotal.at(0) size: "<<dTotal.at(0).size();
    std::cout << '\n';
    std::cout << " ------------------------------------- ";
    std::cout << '\n';
    ...
    for (unsigned k=0; k<n; k++)
    {
        ...
        for (unsigned i=0; i<m; i++)
        {
            ...
            std::cout<<"Score alternative [i]: "<<wS2Appoggio;
            std::cout << '\n';
    ...
    for (unsigned i=0; i<n; i++)
    {
        for (unsigned j=0; j<m; j++)
        {
			ui->fuzzyResultsOnscreen->append("Score alternative [ij]" + QString::number(wS2Total.at(i).at(j)));
            std::cout << " ------------------------------------- ";
            std::cout << '\n';
