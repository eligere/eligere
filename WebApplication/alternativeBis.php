	...
	<div class="container">
					...
					foreach ($arrayAlternative as $alt2) {
						if( $alt2->id > $alt1->id){
							...
							echo "<tr><td class='alert alert-success text-center'> ". $alt1->name."</td> 
    							  <td class='alert alert-success text-center'> vs </td> 
		...
		<div class="row">  		
  			...
  			<div class="col-md-4"> 
		        ...
		        <button type="submit"  >Next alternative <span class="glyphicon glyphicon-chevron-right"> </span></button>
